...
<div>
    ...
    <p class="mt-1 text-sm text-gray-500">Boş bırakırsanız otomatik kategoriye göre resim seçilir</p>
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Tehlikeli Bölge</h3>
                        <form action="{{ route('admin.products.destroy', $product) }}" method="POST" 
                              onsubmit="return confirm('Bu ürünü silmek istediğinize kesinlikle emin misiniz? Bu işlem geri alınamaz!');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                Ürünü sildiğinizde tüm sipariş geçmişi korunur ancak ürün artık görüntülenemez.
                            </p>
                        </form>
                    </div>
                </div>
